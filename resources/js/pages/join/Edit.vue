<template>
	<div>
		<div v-if="loading && !this.selectedAcademy" class="container pt-md-6rem">
			<v-progress-circular indeterminate teal></v-progress-circular>
		</div>
		<div v-if="!loading && this.selectedAcademy && this.selectedAcademyDetails">
			<v-app-bar
				absolute
				elevate-on-scroll
			...
			>
				<v-toolbar-title>Join TeamFCAT - Edit vacancy</v-toolbar-title>
...
export default {
	...
	watch: {
		...
		selectedSalary() {
			...
			if (this.selectedSalaryDetails !== undefined) {
