						...
						<v-carousel-item>
							<v-card>
								...
								<v-sheet color="grey lighten-2">
									<v-img height="550" src="/images/6.jpg"></v-img>
								</v-sheet>
							</v-card>
						</v-carousel-item>
						<v-carousel-item>
						...
						<v-carousel-item>
							<v-card>
								...
								<v-sheet color="purple lighten-2">
									<v-img height="550" src="/images/8.jpg"></v-img>
								</v-sheet>
							</v-card>
						</v-carousel-item>
						<v-carousel-item>
							<v-card>
								...
								<v-sheet color="blue lighten-2">
									<v-img height="550" src="/images/9.jpg"></v-img>
								</v-sheet>
							</v-card>
						</v-carousel-item>
						<v-carousel-item>
							<v-card>
								...
								<v-sheet color="grey lighten-2">
									<v-img height="550" src="/images/10.jpg"></v-img>
								</v-sheet>
							</v-card>
						</v-carousel-item>
					</v-carousel>
